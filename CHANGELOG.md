...
- Use the `/forgeloop.` command prefix to easily discover Spec Kit-related commands.
...
- All command files now prefixed with `forgeloop.` (e.g., `forgeloop.specify.md`, `forgeloop.plan.md`) for better discoverability and differentiation in IDE/CLI command palettes and file explorers
